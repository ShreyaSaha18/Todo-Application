  ...
  return (
    <div className="bg-white place-self-center w-11/12 max-w-md flex flex-col p-7 min-h-[550px] rounded-xl">
      ...
      <div className="flex items-center mt-7 gap-2">
        ...
        <h1 className="text-3xl font-semibold text-red-500">To-Do List</h1>
      </div>
      {/* input box */}
      <div className="flex items-center my-7 bg-orange-100 rounded-full">
        ...
        <button className="border-none rounded-full bg-orange-400 w-32 h-14 text-white text-lg font-medium cursor-pointer" onClick={add}>ADD +</button>
      </div>
    {/* Todo List */}
    <div>
